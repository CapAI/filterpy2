...
import numpy as np
from filterpy2.memory import FadingMemoryFilter
from filterpy2.gh import GHKFilter


def dotest_2d_data():
    """tests having multidimensional data for x"""

    fm = FadingMemoryFilter(
        x0=np.array([[0.0, 2.0], [0.0, 0.0]]), dt=1, order=1, beta=0.6
    )
